...
if story_agent and screenplay_agent and storyboard_agent and video_agent:
    root_agent = Agent(name='director_agent', model=MODEL, description=DESCRIPTION, instruction=load_prompt_from_file('director_agent.txt'), sub_agents=[story_agent, screenplay_agent, storyboard_agent, video_agent])
