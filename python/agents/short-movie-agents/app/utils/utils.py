...
def load_prompt_from_file(filename: str, default_instruction: str='Default instruction.') -> str:
    ...
    try:
        ...
        logger.warning(f'WARNING: Instruction file not found: {filepath}. Using default.')
