...
podcast_transcript_agent = SequentialAgent(name='podcast_transcript_agent', description='Executes a sequence of podcast generation steps', sub_agents=[podcast_topics_agent, podcast_episode_planner_agent, podcast_transcript_writer_agent])
