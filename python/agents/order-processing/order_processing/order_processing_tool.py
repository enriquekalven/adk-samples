...
order_processing_tool = ApplicationIntegrationToolset(project=GOOGLE_CLOUD_PROJECT, location=GOOGLE_CLOUD_LOCATION, integration=APPINT_PROCESS_NAME, triggers=[APPINT_PROCESS_TRIGGER], tool_instructions=TOOL_INSTR)