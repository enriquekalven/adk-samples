...
async def extract_text_from_pdf_artifact(pdf_path: str, tool_context: ToolContext) -> str:
...
async def save_html_to_artifact(html_content: str, output_filename: str, tool_context: ToolContext) -> str:
