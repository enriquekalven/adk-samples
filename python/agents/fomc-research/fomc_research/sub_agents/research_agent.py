...
ResearchAgent = Agent(model=MODEL, name='research_agent', description='Research the latest FOMC meeting to provide information for analysis.', instruction=research_agent_prompt.PROMPT, sub_agents=[SummarizeMeetingAgent], tools=[store_state_tool, compare_statements_tool, fetch_transcript_tool, compute_rate_move_probability_tool], before_model_callback=rate_limit_callback)