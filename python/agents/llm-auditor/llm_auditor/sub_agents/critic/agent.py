...
def _render_reference(callback_context: CallbackContext, llm_response: LlmResponse) -> LlmResponse:
    ...
    return llm_response
critic_agent = Agent(model='gemini-2.5-flash', name='critic_agent', instruction=prompt.CRITIC_PROMPT, tools=[google_search], after_model_callback=_render_reference)